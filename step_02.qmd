...
# step 1 scaling was between 1 and 2
...
```{r alt_response}
# THIS IS AN ALTERNATIVE CLOSURE/RESPONSE SCENARIO WHICH WILL HAVE TO BE
# UPDATED ON THE FLY
response_alt <- daedalus_timed_npi(
  45, 75,
  list(daedalus.data::closure_strategy_data[["economic_closures"]]),
  country
)
```
